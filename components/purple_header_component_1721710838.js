...
Vue.component("purple_header_component_1721710838", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Analyze Ethereum-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Analyze Ethereum.html">Analyze Ethereum</a></li>
                        ...
                        <li><a id="Real-Time Tracking-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Real-Time Tracking.html">Real-Time Tracking</a></li>
                        <li><a id="Advanced Analytics-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Advanced Analytics.html">Advanced Analytics</a></li>
                        <li><a id="Insightful Dashboard-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="Insightful Dashboard.html">Insightful Dashboard</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">
                            <li><a id="mobile-Analyze Ethereum-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Analyze Ethereum.html">Analyze Ethereum</a></li>
                            ...
                            <li><a id="mobile-Real-Time Tracking-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Real-Time Tracking.html">Real-Time Tracking</a></li>
                            <li><a id="mobile-Advanced Analytics-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Advanced Analytics.html">Advanced Analytics</a></li>
                            <li><a id="mobile-Insightful Dashboard-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Insightful Dashboard.html">Insightful Dashboard</a></li>
                        </ul>
                    </nav>
